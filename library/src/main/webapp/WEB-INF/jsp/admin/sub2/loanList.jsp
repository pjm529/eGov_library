...
<head>
<meta charset="UTF-8">
<title>라온도서관 > 관리자 > 도서관련 > 대출중도서</title>
            ...
            <div class="doc-info">
                ...
                <div class="doc-title">
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="${pageContext.request.contextPath}/admin/list.do">대출중도서</a>
                        </li>
                    </ul>
                </div>
            </div>
                            ...
                            <div class="table-wrap">
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        <c:forEach var="list" items="${loanList}">
                                            <tr>
                                                <td>${list.userId}</td>
                                                ...
                                                <td>
                                                    <form action="${pageContext.request.contextPath}/admin/returnBook.do" method="post"
