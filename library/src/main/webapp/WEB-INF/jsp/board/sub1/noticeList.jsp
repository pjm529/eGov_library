...
<link rel="stylesheet" href="${pageContext.request.contextPath}/css/board/sub1/notice_sb_page.css">
<script
                    ...
                    <div class="doc"> 
                        <div class="wrapper-bbs">
                            ...
                            <div class="table-wrap">
                                ...
                                onclick="location.href='${pageContext.request.contextPath}/board/noticeInsertPage.do'" style="cursor: pointer">글쓰기</button>
                                </sec:authorize>
...
<script>
	...
	$(function() {
		...
		$(".contentGo a").on("click", function(e) {
			e.preventDefault();
			moveForm2.find("input[name = 'noticeNo']").val($(this).attr("href"));
			moveForm2.attr("action", "${pageContext.request.contextPath}/board/noticeContent.do");
			moveForm2.submit();
		}); 
