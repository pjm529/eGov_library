...
<title>라온도서관 > 열린공간 > 묻고답하기</title>
	<link rel="stylesheet" href="${pageContext.request.contextPath}/css/board/sub3/answer_content_page.css">
</head>
<script
                ...
                <div class="content">
                    <div class="doc">
                        <div class="wrapper-bbs">
                            ...
                            <input type="hidden" value="${answer.answerNo}" name="${answer.answerNo}">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="bbs-title" colspan="6">
                                            	<div style="width: 970px; height:auto; white-space: normal;">
													<b><c:out value="${answer.answerTitle}"/></b> 
                                            	</div> 
                                            </td>
                                        </tr>
                                        ...
                                        <!-- 작성자 | 작성일 | 조회수 -->
                                         <tr>
                                            ...
                                            <td>
                                            	${fn:substring(answer.answerRegDate, 2, 16)}
	                                            <c:if test="${not empty answer.answerModifyDate}">
	                                            	<span style="font-size:12px;">(${fn:substring(answer.answerModifyDate, 2, 16)} 수정)</span>
	                                            </c:if>
	                                        </td>
                               ...
                               <div class="delete_wrap">
	                               <form action="${pageContext.request.contextPath}/board/answerDelete.do" method="get" onsubmit="return false" class="delete_form">
								...
								<div class="update_wrap">
									<form action="${pageContext.request.contextPath}/board/answerModifyPage.do" method="get">
	                               		<input type="hidden" name="answerNo" value="${answer.answerNo}">
	                               		<input type="hidden" name="amount" value="${cri.amount}">
	                               		<input type="hidden" name="page" value="${cri.page}">
	                               		<input type="hidden" name="type" value="${cri.type}">
