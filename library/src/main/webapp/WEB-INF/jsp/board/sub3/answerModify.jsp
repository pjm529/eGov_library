...
<title>라온도서관 > 열린공간 > 묻고답하기</title>
	<link rel="stylesheet" href="${pageContext.request.contextPath}/css/board/sub3/answer_modify_page.css">
</head>
<script
                    ...
                    <div class="doc">
                        <div class="wrapper-bbs">
                            ...
                            <div class="table-wrap">
                                <form action="${pageContext.request.contextPath}/board/answerModify.do" method="post" onsubmit="return false;">
                                	<input type="hidden" name="answerNo" value="${answer.answerNo}" >
                                	<input type="hidden" name="enquiryNo" value="${answer.enquiryNo}" >
                                    <input type="hidden" name="aWriterName" value="<sec:authentication property="principal.member.userName"/>">
                                    ...
                                    <table class="bbs-edit">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                ${fn:substring(answer.answerRegDate, 0, 11)}
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="4" style="padding: 8px 0px;">
                                                    <textarea id="popContent" name="answerContent">
...
<script>
	$(function() {
		...
		CKEDITOR.replace('popContent', {
            filebrowserImageUploadUrl: "${pageContext.request.contextPath}/imageUpload.do?boardName=answer",
            height: 500
        });
